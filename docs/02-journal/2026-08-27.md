...
J'ai aussi fait la connaissance de quelques capteurs: Les capteurs de son; de l'humidité, émetteur-récepteur, bouton poussoire ![alt text](Capteur.jpeg) et un actionnaeur comme le ruban LED.
Ensuite on j'ai appris la programmation avec l'application  V5.6.0 ( programmer en Blocs un jeu de lumière avec CyberPi ![alt text](<CyberPi jeu de lumières.jpeg>) )

**Du modèle 3D au G-Code**
On a fait la pratique en concevant un modèle 3D avec Bambou Studio et l'imprimer ![alt text](image.png) ![alt text](<Cube 3D.jpeg>)

J'ai également apprit la conception et l'impression d'une carte de visite avec XTool et le découper au laser ![alt text](image-1.png)
## Raté, puis corrigé
